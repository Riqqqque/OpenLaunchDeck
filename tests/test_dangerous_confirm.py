...
def test_dangerous_button_requires_second_press():
    service = DangerousConfirmService(arm_seconds=1, confirm_delay_seconds=0)
...
def test_dangerous_button_rejects_immediate_duplicate_press():
    service = DangerousConfirmService(arm_seconds=1, confirm_delay_seconds=1)
