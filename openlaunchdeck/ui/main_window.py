...
class MainWindow(QMainWindow):
    ...
    def _build_main_layout(self) -> None:
        ...
        header_layout.setContentsMargins(18, 9, 16, 9)
        ...
        deck_layout.setContentsMargins(18, 14, 18, 18)
        deck_layout.setSpacing(12)
        deck_header = QHBoxLayout()
        self.deck_title = QLabel("Launchpad Grid")
    ...
    def select_button(self, button_id: str) -> None:
        if button_id != self.grid.selected_button_id:
    ...
    def _apply_responsive_layout(self, force: bool = False) -> None:
        ...
        if self._grid_focus_mode or short_workspace:
            self.deck_layout.setContentsMargins(12, 8, 12, 12)
            self.deck_layout.setSpacing(7)
        else:
            self.deck_layout.setContentsMargins(18, 14, 18, 18)
