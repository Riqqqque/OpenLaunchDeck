...
Latest verified release: `v0.1.29`

Release assets include:

- `OpenLaunchDeckSetup-0.1.29.exe`
- `OpenLaunchDeckSetup-0.1.29.exe.sha256`
- `OpenLaunchDeck-0.1.29-Windows.zip`
- `OpenLaunchDeck-0.1.29-Windows.zip.sha256`
